...
import customerTransfersRouter from "./routes/customerTransfers.js";
...
app.use(customerTransfersRouter);
    ...
    try {
      ...
      if (error) {
        ...
        return res.status(500).json({
          ...
          message:
            "Unable to load transfers from Supabase.",
...
app.put(
  ...
  async (req, res) => {
    ...
    try {
      ...
      /* =====================================
         APPROVED LOAN VALIDATION
      ===================================== */

      const principal =
        Number(
          existingApplication.amount
        );

      const duration =
        Number(
          existingApplication.duration_months
        );
  ...
  return res.status(400).json({
    ...
    message:
      ...
      if (
        ...
        console.log(
          "Repayment schedules already exist for loan:",
          loan.id
        );
  ...
  rejection_reason:
    null
      ...
      if (applicationUpdateError) {
        ...
        console.error(
          "UPDATE APPROVED APPLICATION ERROR:",
...
(
  ...
  console.error(
    ...
    notificationError
      ...
      console.error(
        "ADMIN LOAN APPROVAL SERVER ERROR:",
        error
      );
      ...
      return res.status(500).json({
        ...
        message:
          "Loan application approval could not be completed.",
