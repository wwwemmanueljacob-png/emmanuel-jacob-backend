    ...
    try {
      ...
      if (
        ...
        return res.status(400).json({
          success: false,
          message:
            "A valid repayment duration is required."
        });
...
/*
=========================================================
GET LOGGED-IN CUSTOMER LOAN APPLICATIONS
=========================================================

GET
/api/loans/my-applications

Returns applications belonging to the
...
Retrieves applications for a specified customer ID.
=========================================================
*/
